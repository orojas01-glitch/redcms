...
if(empty($_SESSION['alias']))
	header('Location: http://'.BASE_URL.'');
		...
		$result = $db->query("SELECT * FROM RED_SubCategories WHERE RecordID='".$RecordID."'");
...
<div class="container_12 cp_padtop">
    <div class="wrapper">
        ...
        <div class="wrapper">
         <div class="titleleft">
            	<label>SubCategory Title: <input name="Title" type="text" id="title" value="<?php echo $row['Title']?>" /></label>
            </div>
            <div class="titleleft">
            	<label>Alias: <input name="SubCategories" type="text" id="title" value="<?php echo $row['SubCategories']?>" /></label>
            </div>
		...
		<div class="wrapper">
         	<div class="titleleft">
                ...
                <?php
                $db= new connection(DBHOST, DBUSER, DBPASS, DBNAME);
                 $result3 = $db->query("SELECT Title, Alias, Active FROM RED_Articles WHERE SubCategories='".$row['SubCategories']."' ORDER BY Updated DESC");
         ...
         <input type="hidden" name="CurrentSubCategory" id="CurrentSubCategory" value="<?php echo $row['SubCategories']?>" />
