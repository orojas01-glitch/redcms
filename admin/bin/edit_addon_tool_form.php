<?php
/**
 * Protected core-owned editor for one manifest-declared add-on tool form.
 */
...
$request = red_addon_admin_tool_form_endpoint_request($_POST);
if (!is_array($request)) {
...
try {
    ...
    if (($context['ready'] ?? false) !== true) {
        ...
        echo red_addon_admin_tool_form_endpoint_render($context);
    }
} catch (Throwable $throwable) {
    error_log('RED-CMS administrator form editor endpoint failed.');
