...
$currentCategory = strtolower(red_admin_post_text('CurrentCategory'));
$data = red_admin_area_update_payload($_POST, 'Categories');
...
$renaming = array_key_exists('Categories', $data) && $newCategory !== '' && $newCategory !== $currentCategory;
if ($renaming) {
    ...
    $areaRows = red_admin_update_area($db->connection, 'RED_Categories', 'Categories', $recordId, $data);
