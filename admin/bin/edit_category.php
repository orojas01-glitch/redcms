...
<div class="container_12 cp_padtop">
    <div class="wrapper">
        ...
        <div class="wrapper">
         <div class="titleleft">
                <label>Category Title: <input name="Title" type="text" id="title" value="<?php echo red_admin_area_html($row['Title']); ?>" /></label>
            </div>
            <div class="titleleft">
                <label>Alias: <input name="Categories" type="text" id="title" value="<?php echo red_admin_area_html($row['Categories']); ?>" /></label>
            </div>
        ...
        <textarea name="Description" id="ShortDesc" cols="" rows="4"><?php echo red_admin_area_html($row['Description']); ?></textarea></label>
         ...
         <input type="hidden" name="CurrentCategory" id="CurrentCategory" value="<?php echo red_admin_area_html($row['Categories']); ?>" />
