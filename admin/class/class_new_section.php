...
function run_insert_section (insert_section)
{
	...
	if (data=='yes')
	{
	$('#msggbox_insert_section').html("Section Added.")
	.hide()
	...
	{
	$('#msggbox_insert_section').html("Error. Please try again.")
	.hide()
	.fadeIn(1500, function() {
	$('#msggbox_insert_section');
	});
...
<form id="insert_section" name="insert_section" class="cp" method="post" onSubmit="return run_insert_section(this);">
<fieldset>
<div class="container_12 cp_padtop">
    <div class="wrapper">
        ...
        <div class="wrapper">
            <div class="titleleft">
            	<label>Section: <input name="Sections" type="text" id="title" value="" /></label>
            </div>
...
//                $db->close();
        ...
        <input type="submit" name="submit" value="Save" id="save"/> <span id="msggbox_insert_section" style="display:none"></span>
        </div>
        </article>
    </div>
</div>
