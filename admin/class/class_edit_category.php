...
class editcategory
{
	public function category_form()
	{
		...
		echo '<form id="editcategory" name="editcategory" class="cp"><fieldset>';
		echo '<div class="header">';
		echo '<div class="titleleft title"><strong>Category Title</strong>';
		echo '</div>';
        ...
        while($row = mysqli_fetch_assoc($result))
        {
            ...
            echo '<img src="/admin/images/ico_edit.png" onClick="editcategories(' .$RecordID . ');" title="Edit" style="cursor:pointer">';
            echo '</div>';
			echo '</label>';
			echo '</div>';
        }
