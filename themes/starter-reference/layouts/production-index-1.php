...
if (!is_array($layout) || ($layout['mode'] ?? '') !== 'production') {
    throw new RuntimeException('Production index-1 layout context is unavailable.');
}
?>
<main id="main-content" class="starter-layout starter-layout--index-1" tabindex="-1">
