...
if (!is_array($layout) || ($layout['mode'] ?? '') !== 'production') {
    throw new RuntimeException('Adriana feature-grid layout context is unavailable.');
}
?>
<main id="main-content" class="adriana-layout adriana-layout--feature-grid" tabindex="-1">
