...
if (!is_array($layout) || ($layout['mode'] ?? '') !== 'production') {
    throw new RuntimeException('Adriana directory-hub layout context is unavailable.');
}
...
?>
<main id="main-content" class="adriana-layout adriana-layout--directory-hub" tabindex="-1">
    <?php if ($isSourcePage) : ?>
        <?= $sourcePageHtml ?>
