...
if (!is_array($layout) || ($layout['mode'] ?? '') !== 'production') {
    throw new RuntimeException('Adriana campaign-story layout context is unavailable.');
}
...
?>
<main id="main-content" class="adriana-layout adriana-layout--campaign-story" tabindex="-1">
    <?php if ($isSourcePage) : ?>
        <?= $sourcePageHtml ?>
    ...
    <section class="section"><div class="wrapper split-section adriana-layout__slot"><?= $layout['slots'][1] ?></div></section>
    <section class="section dark-band"><div class="wrapper adriana-layout__slot"><?= $layout['slots'][2] ?></div></section>
    <section class="section testimonial-section"><div class="wrapper adriana-layout__slot"><?= $layout['slots'][3] ?></div></section>
    <section class="section ivory"><div class="wrapper adriana-layout__slot"><?= $layout['slots'][4] ?></div></section>
