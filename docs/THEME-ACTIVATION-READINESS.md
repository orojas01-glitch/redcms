...
| `/administracion/instructions` | selected Article `89196971`, Spanish, trusted rich HTML and 21 confined local manual images | `index-2`; Page position `1` | Discoverable through the Article listing; no fallback | Exact fixed Instructions preview |
...
| Instructions body | 18,907 source bytes; SHA-256 `8dc4cd54cf74d74f9d0d41be81acba2921d70044043e0f5d6520e443f61f66ad`; sanitized to 1,701,993 bytes at SHA-256 `67bc1d9d8e2bfc1bf63defec03ce616eabba0542fbfc6f446bdd8f495dd13894` | Exact fixed trusted-HTML canary passes |
| Instructions local media | 21 references; all 21 present; 1,264,187 bytes; manifest SHA-256 `b692747db87cfc99da551e0f7b3bd82d828eaf032facb67b1820ace3becdace4`; embedded as bounded PNG/JPEG data | Complete fixed preview dependency set |
