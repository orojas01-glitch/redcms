...
- permission-enforced component create, parent-metadata write, revision-history
...
3. Started: implement generic package component persistence and bounded
   ...
   atomic restore execution are complete; component creation, parent-metadata
   writes, history UI, and delete behavior remain.
