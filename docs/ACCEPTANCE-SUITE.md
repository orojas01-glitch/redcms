...
constrained service/default-component enablement foundations, fail-closed
enabled-package request bootstrap, plus Milestone 5 content-version, direct
page-structure, and custom Layout Builder foundations.
...
11-assertion safe component dispatch, 38-assertion SEO database, 29-assertion
content-revision, 21-assertion layout-distribution, and 36-assertion
custom-layout lifecycles. The normalized schema matched signature
