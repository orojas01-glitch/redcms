...
The separate 36-assertion transactional update fixture permits at most one
...
36-assertion transactional component-editor update, history, and restore-preflight lifecycle,
