...
The separate 126-assertion destination/creation/parent-metadata/public-placement/delete fixture
permits at most one
...
counts, and changed-package/placement-drift refusal. The parent-metadata
