...
The separate 83-assertion creation/preflight/runner/parent-metadata/public-placement/delete fixture
permits at most one
...
refusal, rollback after forced `move`-revision failure, lifecycle/theme and
source/target serialization, exact seven-field source mutation, unchanged
package and target postconditions, one explicit-actor `move` revision, and
single-use plan refusal.
...
83-assertion component-creation preflight/atomic-runner/parent-metadata/public-placement-preflight/atomic-placement/atomic-delete lifecycle,
