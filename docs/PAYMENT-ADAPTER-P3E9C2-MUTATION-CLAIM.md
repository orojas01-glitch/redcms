...
P3E-9C3A separately adds immutable start/result evidence around only a
core-owned transport double, and P3E-9C3B1 adds its command contract. P3E-9C3B2
must run the disposable apply rehearsal. P3E-9D remains the separately approved first real Stripe Sandbox
