...
LAUNCH_MODE="${RED_SUBSCRIPTION_LAUNCH_MODE:-sealed}"
REAL_ATTEMPT_CONFIRMED="${RED_SUBSCRIPTION_REAL_ATTEMPT_CONFIRMED:-}"
OWNER_AUTHORIZATION_SHA256="${RED_SUBSCRIPTION_OWNER_AUTHORIZATION_SHA256:-}"
LAUNCH_SECRET_REFERENCES="${RED_ADDON_SECRET_REFERENCES:-}"
LAUNCH_SECRET_VALUES_JSON="${RED_ADDON_SECRET_VALUES_JSON:-}"
TEMP_ROOT=""
STAGED_PROJECT=""
ADMIN_DEFAULTS_FILE=""
APP_ACCOUNT_USER=""
...
unset RED_SUBSCRIPTION_LAUNCH_MODE
unset RED_SUBSCRIPTION_REAL_ATTEMPT_CONFIRMED
unset RED_SUBSCRIPTION_OWNER_AUTHORIZATION_SHA256
unset RED_ADDON_SECRET_REFERENCES
...
red_subscription_launch_cleanup() {
    ...
    LAUNCH_SECRET_VALUES_JSON=''
    unset LAUNCH_SECRET_VALUES_JSON
...
RED_SUBSCRIPTION_LAUNCH_MODE="$LAUNCH_MODE" \
RED_SUBSCRIPTION_REAL_ATTEMPT_CONFIRMED="$REAL_ATTEMPT_CONFIRMED" \
RED_SUBSCRIPTION_OWNER_AUTHORIZATION_SHA256="$OWNER_AUTHORIZATION_SHA256" \
RED_ADDON_SECRET_REFERENCES="$LAUNCH_SECRET_REFERENCES" \
RED_ADDON_SECRET_VALUES_JSON="$LAUNCH_SECRET_VALUES_JSON" \
