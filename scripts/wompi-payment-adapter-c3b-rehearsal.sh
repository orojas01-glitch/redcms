...
usage() {
    printf 'Usage: %s\n' "$0"
    printf '%s\n' 'Runs the exact Store Lite 0.1.35 plus Wompi 0.1.3 C3B disposable rehearsal.'
}
...
WOMPI_REVISION='277760e6cd727fab6795524b654ab55c4597bfa2'
...
if [[ "$store_version" != '0.1.35' || "$wompi_version" != '0.1.3' ]]; then
